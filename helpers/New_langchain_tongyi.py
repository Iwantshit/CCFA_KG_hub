...
OPENAI_API_KEY = "sk-737f51cd1f7d4db290558f1c3e157747"
...
llm = chat_model = ChatOpenAI(openai_api_key = OPENAI_API_KEY, openai_api_base = os.environ['OPENAI_API_BASE'], max_tokens=4096, model="deepseek-r1-distill-llama-70b")


def TYgraphPrompt(prompt: str, metadata={}, model="deepseek-r1-distill-llama-70b"):
    SYS_PROMPT = (
